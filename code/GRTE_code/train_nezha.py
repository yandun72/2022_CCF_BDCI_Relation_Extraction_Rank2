...
from model import GRTE,GRTENeZha
from util import *
...
from nezha_model.configuration_nezha import NeZhaConfig
from nezha_model.modeling_nezha import NeZhaModel
...
#         val_data = all_data[val_index]
        ...
        config = NeZhaConfig.from_pretrained(args.pretrained_model_path)
        ...
        train_model = GRTENeZha.from_pretrained(pretrained_model_name_or_path=args.pretrained_model_path, config=config)
        train_model.to("cuda")
...
#         ]
        ...
        optimizer_grouped_parameters = [
            {'params': [p for n, p in train_model.named_parameters() if not any(nd in n for nd in no_decay) and 'nezha' in n],
             'weight_decay': args.weight_decay,'lr': args.bert_learning_rate},
            {'params': [p for n, p in train_model.named_parameters() if not any(nd in n for nd in no_decay) and not 'nezha' in n],
             'weight_decay': args.weight_decay,'lr': args.learning_rate},
            {'params': [p for n, p in train_model.named_parameters() if any(nd in n for nd in no_decay) and 'nezha' in n], 
             'weight_decay': 0.0,'lr': args.bert_learning_rate},
            {'params': [p for n, p in train_model.named_parameters() if any(nd in n for nd in no_decay) and not 'nezha' in n], 
